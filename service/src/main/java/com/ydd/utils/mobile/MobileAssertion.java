...
/**
 * 断言类，用于设置检查点的方法
 * @author Administrator yangfan
 *
 */
public class MobileAssertion extends TestMobileBaseCase {
	//收集断言异常用于报表日志展示
	...
	private static Log log=new Log(MobileAssertion.class);
	...
	{
		WebDriver driver=TestMobileBaseCase.driver;
		ScreenShot screenShot=new ScreenShot(driver);
		//设置截图名字
		Date nowDate=new Date();
		screenShot.setscreenName(MobileAssertion.formatDate(nowDate));
...
//		Assertion.assertInfolList.add("&lt;a href=\"snapshot/"+Assertion.formatDate(nowDate)+".jpg\" &gt;&lt;img height=\"100\" width=\"100\" src=\"snapshot\\"+Assertion.formatDate(nowDate)+".jpg\"&gt;&lt;/img&gt;&lt;/a&gt;&lt;br/&gt;"+"&lt;a href=\"snapshot\\"+Assertion.formatDate(nowDate)+".jpg\" &gt;点击查看大图&lt;/a&gt;\n");
		MobileAssertion.messageList.add("&lt;a class=\"clickbox\" href=\"#url\"&gt;\n"
				+ "&lt;img src=\"snapshot/"
				+ MobileAssertion.formatDate(nowDate)
	...
	public static  void VerityTextPresent(String exceptStr)
	{
		...
		try {
			...
			// TODO: handle exception
			flag=false;
			MobileElementAction.noSuchElementExceptions.add(e);
			e.printStackTrace();
			///AssertFailedLog();
		}
		try {
	...
	public static void main(String[] args) {
		...
		MobileAssertion.VerityCationString("刘兰39", "刘兰");
		MobileAssertion.VerityCationString("刘兰39", "刘兰", "验证是否按医生姓名查询出结果");
	}
