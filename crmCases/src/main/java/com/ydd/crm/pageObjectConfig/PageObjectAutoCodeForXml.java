package com.ydd.crm.pageObjectConfig;
...
public class PageObjectAutoCodeForXml {
	...
	static  String path="crmCases/src/main/java/com/ydd/crm/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("private String path=\"src/main/java/ydd/crm/pageObjectConfig/UILibrary.xml\";\n");
