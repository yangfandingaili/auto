 ...
 *
 */
public class WebAssertion extends TestWebBaseCase {
	//收集断言异常用于报表日志展示
	...
	private static Log log=new Log(WebAssertion.class);
...
//		Assert.assertEquals(MobileElementAction.noSuchElementExceptions.size(), 0);
	...
	public static void main(String[] args) {
		...
		WebAssertion.VerityCationString("刘兰39", "刘兰");
		WebAssertion.VerityCationString("刘兰39", "刘兰", "验证是否按医生姓名查询出结果");
	}
